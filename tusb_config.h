...
// --- ENABLED CLASSES ---
#define CFG_TUD_CDC     0   // <— vypnout
#define CFG_TUD_MSC     0
#define CFG_TUD_HID     0
#define CFG_TUD_MIDI    0
#define CFG_TUD_VENDOR  0
#define CFG_TUD_AUDIO   1   // necháme jen AUDIO

// --- AUDIO (6ch mic: device -> host) ---
#define CFG_TUD_AUDIO_FUNC_1_CTRL_BUF_SZ            64
#define CFG_TUD_AUDIO_FUNC_1_DESC_LEN               TUD_AUDIO_DESC_IAD_LEN
#define CFG_TUD_AUDIO_FUNC_1_N_AS_INT               1

#define CFG_TUD_AUDIO_FUNC_1_N_CHANNELS_TX          6   // mic (device->host)
#define CFG_TUD_AUDIO_FUNC_1_N_CHANNELS_RX          0   // žádný playback
...
// 1ms rámec: 16k/1000 * 6ch * 2B = 192 B
#define CFG_TUD_AUDIO_FUNC_1_EP_IN_SZ_MAX           (16000/1000 * 6 * 2)
// SW ring buffer ~2ms
